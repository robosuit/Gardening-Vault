...
Tags: bean-lima, zone-7b, vegetable, bloom-fast, pollinator-moderate
---
...
- Feeding level: Medium
- Rotation note: Good bridge crop before leafy greens

## Planting Calendar (Zone 7B)
- Spring sow/plant window: Apr 25-Jun 1
- Outdoor transplant window: Direct sow only in warm soil
- Indoor start lead time: Direct sow after frost
...
## Varieties
- Henderson Bush: compact and early
- Fordhook 242: large seeded bush lima
- Christmas Lima: speckled heirloom pole type

## Crop Notes
Needs consistent warmth for pod set.
