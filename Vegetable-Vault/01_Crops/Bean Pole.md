...
Feeding Level: Nitrogen Fixer
Companion Group: Legume
Tags: bean-pole, zone-7b, vegetable, bloom-fast, pollinator-moderate
---
...
## Quick Use Guide
- Seed depth: 1-1.5 in
- Spacing: rows 36-42 in, plants 4-6 in
- Feeding level: Nitrogen Fixer
- Rotation note: Follow with brassicas or fruiting crops

## Planting Calendar (Zone 7B)
- Spring sow/plant window: Apr 15-Jun 15
- Fall sow/plant window: Jul 10-Aug 1
- Outdoor transplant window: Direct sow at trellis base
...
- Seed/planting depth: 1-1.5 in
- Row spacing: 36-42 in
- In-row spacing: 4-6 in
...
## Varieties
- Kentucky Wonder: classic pole snap bean
- Blue Lake Pole: heavy producer
- Fortex: long tender filet bean

## Crop Notes
Provide a strong trellis before sowing.
