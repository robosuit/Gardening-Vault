...
Water: Moderate
Zone: 7B (cool-season crop)
Start Method: See planting calendar and crop notes for direct sow vs transplant guidance.
Start Month: Mar 1-Apr 1
Days to Germination: 5-14 days
Bloom Days: 50-90 days
Bloom Speed Tier: Fast
Harvest: May-Jun and Oct-Nov
Pollinator Value: Moderate
Nectar Level: Moderate
Pollen Level: Moderate
Indoor Bloom Viable: Limited
Feeding Level: Heavy
Companion Group: Brassica
Tags: broccoli, zone-7b, vegetable, bloom-fast, pollinator-moderate
---

# Broccoli

## Quick Use Guide
- Seed depth: 1/4-1/2 in seed; set transplants about 3 in deep
- Spacing: rows 36-42 in, plants 18-24 in
- Feeding level: Heavy
- Rotation note: Do not follow other brassicas

## Planting Calendar (Zone 7B)
- Spring sow/plant window: Mar 1-Apr 1
- Fall sow/plant window: Jul 1-Jul 31
- Outdoor transplant window: Mar 1-Apr 1 and Jul 1-Jul 31
- Indoor start lead time: Start 5-7 weeks before transplant dates
- Frost baseline used: last spring frost Apr 5-Apr 15; first fall frost Oct 25-Nov 5.

## Seed Depth and Spacing
- Seed/planting depth: 1/4-1/2 in seed; set transplants about 3 in deep
- Row spacing: 36-42 in
- In-row spacing: 18-24 in
...
## Varieties
- Green Magic: heat-tolerant heading type
- Belstar: reliable fall performance
- De Cicco: side-shoot heirloom

## Crop Notes
Use insect netting early against cabbage worms.
...
## Bloom Timing and Pollinator Notes
- Start method: See planting calendar and crop notes for direct sow vs transplant guidance.
- Days to germination: 5-14 days
- Bloom from seed: 50-90 days
- Pollinator value: Moderate
