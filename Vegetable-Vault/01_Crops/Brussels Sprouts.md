...
Tags: brussels-sprouts, zone-7b, vegetable, bloom-fast, pollinator-moderate
---

# Brussels Sprouts

## Quick Use Guide
- Seed depth: 1/2 in seed; set transplants about 3 in deep
- Spacing: rows 36-42 in, plants 18-24 in
- Feeding level: Heavy
- Rotation note: Keep 3-year gap from other brassicas

## Planting Calendar (Zone 7B)
- Fall sow/plant window: Jul 1-Jul 15
- Outdoor transplant window: Jul 1-Jul 15
- Indoor start lead time: Start 5-7 weeks before transplanting
- Frost baseline used: last spring frost Apr 5-Apr 15; first fall frost Oct 25-Nov 5.

## Seed Depth and Spacing
- Seed/planting depth: 1/2 in seed; set transplants about 3 in deep
...
## Varieties
- Long Island Improved: heirloom standard
- Diablo: uniform hybrid sprouts
- Jade Cross: compact early hybrid
