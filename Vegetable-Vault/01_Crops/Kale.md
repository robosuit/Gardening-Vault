...
Tags: kale, zone-7b, vegetable, bloom-fast, pollinator-moderate
---
...
- Spacing: rows 24-36 in, plants 8-12 in
- Feeding level: Medium
- Rotation note: Useful bridge after legumes

## Planting Calendar (Zone 7B)
- Spring sow/plant window: Mar 1-Apr 15
- Fall sow/plant window: Jul 15-Aug 15
- Outdoor transplant window: Mar-Apr and Jul-Aug
- Indoor start lead time: Start 4-6 weeks before transplanting
...
## Varieties
- Lacinato: dark blistered leaves
- Red Russian: tender frilly flat leaf
- Winterbor: curly cold-hardy type

## Crop Notes
Sweeter flavor after frost.
