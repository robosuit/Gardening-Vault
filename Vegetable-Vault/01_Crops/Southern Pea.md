...
Tags: southern-pea, zone-7b, vegetable, bloom-fast, pollinator-moderate
---
...
## Quick Use Guide
- Seed depth: 1-1.5 in
- Spacing: rows 24-36 in, plants 3-4 in
- Feeding level: Nitrogen Fixer
- Rotation note: Excellent summer soil-building crop

## Planting Calendar (Zone 7B)
- Spring sow/plant window: Apr 15-Jun 15
- Outdoor transplant window: Direct sow after frost
...
## Varieties
- California Blackeye No. 5: classic black-eyed pea
- Pinkeye Purple Hull: flavorful southern type
- Cream 40: tender cream pea

## Crop Notes
Tolerates heat better than many beans.
