...
Feeding Level: Heavy
Companion Group: Cucurbit
Tags: squash, zone-7b, vegetable, bloom-fast, pollinator-moderate, pollinator-high
---
...
## Quick Use Guide
- Seed depth: 1 in
- Spacing: rows 48-72 in, plants 18-36 in
- Feeding level: Heavy
- Rotation note: Rotate away from cucurbits for 2-3 years

## Planting Calendar (Zone 7B)
- Spring sow/plant window: Apr 25-Jun 15
- Fall sow/plant window: Jul 1-Jul 15
- Outdoor transplant window: Apr 25-May 20 (optional)
- Indoor start lead time: Start 2-3 weeks before transplanting
- Frost baseline used: last spring frost Apr 5-Apr 15; first fall frost Oct 25-Nov 5.

## Seed Depth and Spacing
- Seed/planting depth: 1 in
- Row spacing: 48-72 in
- In-row spacing: 18-36 in
...
## Varieties
- Yellow Straightneck: classic summer squash
- Pattypan: scalloped tender fruits
- Cocozelle: striped elongated heirloom

## Crop Notes
Harvest young fruits for best texture.
