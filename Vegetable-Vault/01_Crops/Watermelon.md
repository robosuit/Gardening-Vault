...
Tags: watermelon, zone-7b, vegetable, bloom-fast, pollinator-moderate, pollinator-high
---
...
## Quick Use Guide
- Seed depth: 1 in
- Spacing: rows 72-96 in, plants 36-48 in
- Feeding level: Heavy
- Rotation note: Do not follow cucurbits in same area
...
- Row spacing: 72-96 in
- In-row spacing: 36-48 in
...
## Varieties
- Sugar Baby: small icebox melon
- Crimson Sweet: mid-size striped classic
- Charleston Gray: large elongated heirloom

## Crop Notes
Use row cover early then remove at flowering for pollination.
